...
switch ($jsOptions['pos']) {
    default:
    case View::POS_END:
        coderfixlab\cropper\CropperAsset::register($this);
        break;
    case View::POS_BEGIN:
        coderfixlab\cropper\CropperBeginAsset::register($this);
        break;
    case View::POS_HEAD:
        coderfixlab\cropper\CropperHeadAsset::register($this);
        break;
    case View::POS_LOAD:
        coderfixlab\cropper\CropperLoadAsset::register($this);
        break;
    case View::POS_READY:
        coderfixlab\cropper\CropperReadyAsset::register($this);
        break;
}
...
$uploadAttachment = $uploadOptions['attachment'];
